...
class Survey_Benches extends Component {
  constructor(props) {
    super(props);
  ...
  saveFormData(updateValue) {
    ...
    if (this.props.suggestPark) {
      return Actions.surveyCoveredArea({ suggestPark: true });
    }
  ...
  render() {
    ...
    return (
      <View ref="surveyForm" style={styles.container}>
        ...
        <Text style={styles.question}>Are there <B>benches</B> at this dog park?</Text>
        <Form ref='surveyFormBenches' style={styles.wrapper}>
          <Button
...
export default connect(mapStateToProps)(Survey_Benches);
