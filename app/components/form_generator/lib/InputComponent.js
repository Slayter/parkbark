...
const {
  View, StyleSheet, TextInput, Text, ViewPropTypes, Platform
} = ReactNative;
    ...
    if (!!this.props.validationFunction) {
      if (this.props.validationFunction.constructor === Array) {
        ...
        this.props.validationFunction.map((valFn, i) => {
          const validationResult = valFn(value, this);
        ...
        const validationResult = this.props.validationFunction(value, this);
        if (validationResult === true) {
          this.valid = true;
        } else {
          this.validationErrors.push(validationResult);
