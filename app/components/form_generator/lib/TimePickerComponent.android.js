...
import { View, StyleSheet, TextInput, Text, TimePickerAndroid, DatePickerAndroid } from 'react-native';
...
export class TimePickerComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <View>
        <Field {...this.props} ref="inputBox" onPress={this._togglePicker.bind(this)}>
          <View
            style={[
